...
const timeline = [
  { phase: 'ROUND 1', range: '18 to 28', detail: 'Idea Submission' },
  { phase: 'ROUND 1 RESULT', range: '30', detail: 'Shortlisted Teams Announced' },
  { phase: 'ROUND 2', range: '1 to 9', detail: 'Prototype Submission' },
  { phase: 'ROUND 2 RESULT', range: '12', detail: 'Finalists Announced' },
  { phase: 'ROUND 3', range: '16 and 17', detail: '24-Hour Grand Finale' },
  { phase: 'ROUND 3 RESULT', range: '17', detail: 'Winners Announced' },
];
...
const menuInformation = {
  ...
  Schedule: {
    ...
    items: ['Round 1: 18th - 28th, idea submission', 'Round 1 results: 30th', 'Round 2: 1st - 9th, prototype submission', 'Round 3: 16th - 17th, grand finale'],
